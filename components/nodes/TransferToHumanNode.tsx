...
interface TransferToHumanNodeData {
  label: string
  message?: string
}
...
export default function TransferToHumanNode(props: NodeProps) {
  ...
  const nodeData = data as TransferToHumanNodeData
  ...
  return (
    <div
      className={`px-4 py-3 shadow-lg rounded-lg bg-gradient-to-br from-orange-500 to-red-600 border-2 overflow-hidden ${
        selected ? 'border-yellow-400' : 'border-orange-300'
      } min-w-[220px] w-[220px]`}
